...
Historical #130 verification attempt. Its provenance and negative result remain
unchanged. Current operator actions follow [the exploration-first procedure](target-execution-feasibility.md): reuse existing working state to investigate
termination; strict reproduction below is required only when verifying promotion.
